...
//GLOBALES
//-----------------------------------------------------------------------------------------------
uint32_t Match_Cnt1=0, Match_Cnt2=0, Cycle=0, AntiRebo=REBOTE_,
PORT_Q1b[3]={PORT_Q11,PORT_Q13,PORT_Q15},
PIN_Q1b[6]={PIN_Q11,PIN_Q13,PIN_Q15},
PORT_Q1a[6]={PORT_Q10,PORT_Q12,PORT_Q14},
PIN_Q1a[6]={PIN_Q10,PIN_Q12,PIN_Q14},
PORT_Z1[3]={PORT_Z11, PORT_Z12, PORT_Z13},
PIN_Z1[3]={PIN_Z11, PIN_Z12, PIN_Z13},

PORT_Q2b[3]={PORT_Q21,PORT_Q23,PORT_Q25},
PIN_Q2b[6]={PIN_Q21,PIN_Q23,PIN_Q25},
PORT_Q2a[6]={PORT_Q20,PORT_Q22,PORT_Q24},
PIN_Q2a[6]={PIN_Q20,PIN_Q22,PIN_Q24},
PORT_Z2[3]={PORT_Z21, PORT_Z22, PORT_Z23},
PIN_Z2[3]={PIN_Z21, PIN_Z22, PIN_Z23};

volatile uint32_t CruceZero1[3]={0,0,0}, CruceZero2[3]={0,0,0}, CruceZero01[3]={0,0,0}, CruceZero02[3]={0,0,0};
uint8_t Conmutar1=0, Conmutar2=0;
...
uint16_t DutyCycle, DutyCycle01, DutyCycle02; 	// fraction of period hi pins are high

volatile int StepID1=0, StepID2=0;  		// commutation step counter, 0..5
